...
CODE = os.environ.get('DICT', 'wil')
# Both WIL and YAT source language is English -> consolidated source-language file uses .en tag.
# (suffix, outfile, doc title, page-word, src-word)
LANGS = {
  'src': ('.md',    f'{CODE}pref_all.en.md', 'Front matter — complete (English, source)', 'Page',     'Source (scan)'),
